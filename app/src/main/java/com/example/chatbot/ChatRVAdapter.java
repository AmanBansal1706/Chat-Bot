...
public class ChatRVAdapter extends RecyclerView.Adapter {
    ...
    switch ( chatsModel.getSender()){
        case  "user":
            ...
            break;
        case "bot" :
            ((BotViewHolde)holder).botMsgTV.setText(chatsModel.getMessage());
            break;
    }
    }
    ...
    public  static  class  BotViewHolde extends  RecyclerView.ViewHolder{
TextView botMsgTV;
        public BotViewHolde(@NonNull View itemView) {
            super(itemView);
            botMsgTV = itemView.findViewById(R.id.idTBBot);
        }
    }
}
